        ...
        <div class="navbar navbar-inverse navbar-fixed-top">
            <div class="adjust-nav">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#"><i class="fa fa-square-o "></i>&nbsp;Proyecto</a>
                </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a href="d.aspx"><i class="fa fa-desktop "></i>Dashboard</a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-edit "></i>Consumidor<span class="fa arrow"></span></a>
                    ...
                    <li>
                         <a href="#"><i class="fa fa-edit "></i>Productor<span class="fa arrow"></span></a>
                    ...
                    <li>
                       <a href="#"><i class="fa fa-edit "></i>Formas de Pago<span class="fa arrow"></span></a>
                      ...
                      <li>
                         <a href="#"><i class="fa fa-edit "></i>Roles<span class="fa arrow"></span></a>
                      ...
                      <li>
                           <a href="#"><i class="fa fa-edit "></i>Formas de entrega<span class="fa arrow"></span></a>
